...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, jp.ecn.sesweb.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, jp.ecn.sesweb.repository.UserRepository.USERS_BY_EMAIL_CACHE);
