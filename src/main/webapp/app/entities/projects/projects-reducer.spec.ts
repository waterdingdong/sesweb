...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './projects.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROJECTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_PROJECTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROJECTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROJECTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROJECTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROJECTS actions', async () => {
      const expectedActions = [
        {
