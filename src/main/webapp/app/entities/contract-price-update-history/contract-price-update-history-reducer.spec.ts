...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './contract-price-update-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRACTPRICEUPDATEHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTRACTPRICEUPDATEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTRACTPRICEUPDATEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTRACTPRICEUPDATEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTRACTPRICEUPDATEHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTRACTPRICEUPDATEHISTORY actions', async () => {
      const expectedActions = [
        {
