...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<IPartnerManager> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARTNERMANAGER_LIST actions', async () => {
    ...
    it('dispatches FETCH_PARTNERMANAGER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARTNERMANAGER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARTNERMANAGER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARTNERMANAGER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARTNERMANAGER actions', async () => {
      const expectedActions = [
        {
