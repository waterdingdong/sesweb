...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './contracts.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRACTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTRACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTRACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTRACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTRACTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTRACTS actions', async () => {
      const expectedActions = [
        {
