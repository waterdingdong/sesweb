...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALESAMOUNT_LIST actions', async () => {
    ...
    it('dispatches FETCH_SALESAMOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SALESAMOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SALESAMOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SALESAMOUNT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SALESAMOUNT actions', async () => {
      const expectedActions = [
        {
