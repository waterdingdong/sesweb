...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMERMANAGER_LIST actions', async () => {
    ...
    it('dispatches FETCH_CUSTOMERMANAGER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CUSTOMERMANAGER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CUSTOMERMANAGER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMERMANAGER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CUSTOMERMANAGER actions', async () => {
      const expectedActions = [
        {
